...
class ManageProductAdapter(context: Context, val onClick:(position: Int, data: String)->Unit) :
    BaseAdapter<Item, ManageProductItemBinding>(context, R.layout.manage_product_item) {
    ...
    override fun onViewHolderBind(
        ...
        binding.dealPrice.text = data.dealPrice.toString()

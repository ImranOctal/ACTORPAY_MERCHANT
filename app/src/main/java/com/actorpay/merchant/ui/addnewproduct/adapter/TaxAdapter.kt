...
import com.actorpay.merchant.repositories.retrofitrepository.models.taxation.Data
import com.skydoves.powerspinner.*
import com.skydoves.powerspinner.databinding.ItemDefaultPowerSpinnerLibraryBinding

class TaxAdapter(powerSpinnerView: PowerSpinnerView
) : RecyclerView.Adapter<TaxAdapter.IconSpinnerViewHolder>(),
